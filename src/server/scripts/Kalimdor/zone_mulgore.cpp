...
#define WAY_POINT 247620
#define OLD_COWBOY 23618
#define FOOD_OBJ 186265
...
public:
    ...
    struct npc_kyle_frenziedAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
			...
			me->SetVisible(true);
			me->GetMotionMaster()->MovePath(WAY_POINT, true);
        }
        ...
        void SpellHit(Unit* Caster, SpellInfo const* Spell) override
        {
            if (!me->GetVictim() && !EventActive && Spell->Id == SPELL_LUNCH)
            {
                ...
                EventActive = true;
				c = me->FindNearestCreature(OLD_COWBOY, 1000);

				IsMovingToLunch = true;
				GameObject * obj = me->FindNearestGameObject(FOOD_OBJ, 40);
				if (obj) {
					me->GetMotionMaster()->MovePoint(POINT_ID, obj->GetPositionX(), obj->GetPositionY(), obj->GetPositionZ());
				}
            }
        }
                ...
                if (EventTimer <= diff)
                {
                    ...
                    switch (EventPhase)
                    {
                        ...
                        case 6:
							EventTimer = 4000;
							if (c) {
								me->GetMotionMaster()->MovePoint(2, c->GetPositionX(), c->GetPositionY(), c->GetPositionZ());
							}
							break;
						case 7:
							EventTimer = 1000;
